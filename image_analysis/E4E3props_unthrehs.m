...
close all
mycolormap = jet(101);
mypathin='/Users/alex/brain_data/E3E4/connectunthresh/'; %'/Users/alex/Documents/MATLAB/E3E4_scripts/'
pathfigs='/Users/alex/brain_data/E3E4/connectunthresh/figs/'; %[mypathin '/figs2/']
...
mypath='/Users/alex/brain_data/E3E4/connectunthresh/'
...
for i=1:numel(ind1)
    runno=runnos{ind1(i)} ;
    myfile=[mypathin,runno,'network_measures.txt'];
    myprops1(i,:,:)=getvprops2(myfile,myroino);
end
...
for i=1:numel(ind2)
    runno=runnos{ind2(i)} ;
    myfile=[mypathin,runno,'network_measures.txt'];
    myprops2(i,:,:)=getvprops2(myfile,myroino);
end
...
for i=1:numel(ind3)
    runno=runnos{ind3(i)} ;
    myfile=[mypathin,runno,'network_measures.txt'];
    myprops3(i,:,:)=getvprops2(myfile,myroino);
end
...
for i=1:numel(ind4)
    runno=runnos{ind4(i)} ;
    myfile=[mypathin,runno,'network_measures.txt'];
    myprops4(i,:,:)=getvprops2(myfile,myroino);
end
